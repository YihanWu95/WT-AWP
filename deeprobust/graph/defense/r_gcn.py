...
class GGCL_F(Module):
    ...
    def __init__(self, in_features, out_features, dropout=0.6):
        ...
        self.weight_miu_delta = Parameter(torch.FloatTensor(in_features, out_features))
        self.weight_miu_delta.requires_grad = False
        self.weight_miu_delta.zero_()
    ...
    def forward(self, features, adj_norm1, adj_norm2, gamma=1):
        ...
        self.miu = F.elu(torch.mm(features, (self.weight_miu+self.weight_miu_delta)))
...
class GGCL_D(Module):
    ...
    def forward(self, miu, sigma, adj_norm1, adj_norm2, gamma=1):
        ...
        miu = F.elu(miu @ (self.weight_miu+self.weight_miu_delta))
...
class RGCN(Module):
    ...
    def fit(self, features, adj, labels, idx_train, idx_val=None, train_iters=200, verbose=False,seed = 0, **kwargs):
        """Train RGCN.
    ...
    def fit_mp(self, features, adj, labels, idx_train, idx_val=None, train_iters=200, verbose=False, awp_weight = 1, awp_gamma = 1, awp_step = 5,awp_method = 'FSGM',idx_test = None,seed = 0,**kwargs):
        """Train RGCN.
