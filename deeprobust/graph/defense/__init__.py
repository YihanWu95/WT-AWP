from .gcn import GCN, GraphConvolution,GraphConvolution2
...
from .adv_training import AdvTraining
import warnings
try:
    from .gat import GAT
...
__all__ = ['GCN', 'GCNSVD', 'GCNJaccard', 'RGCN', 'ProGNN',
           ...
           'ChebNet', 'SGC', 'SimPGCN', 'Node2Vec', 'DeepWalk','AdvTraining','GraphConvolution2','PPNP']
